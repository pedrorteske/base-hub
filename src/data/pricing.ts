export interface PricingItem {
  id: string;
  category: string;
  subcategory?: "nacional" | "internacional";
  service: string;
  unit: string;
  price: number;
  notes?: string;
...
export const pricingData: PricingItem[] = [
  ...
  // Estacionamento Internacional (por MTOW)
  {
    id: "9a",
    category: "Estacionamento",
    subcategory: "internacional",
    service: "MTOW 3 – 9,9 t",
    unit: "por pouso",
    price: 450.00,
  },
  {
